...
boton_crear = CTkButton(master=ventana_creator, text="Generar PDF", width=160, font=fuente_botton, command=lambda:boton_crear_pdf(tipo_doc,ruc,cliente,placa,moneda, ventana_creator,error_label, scroll_tabla_productos,dataset,lmonto,boton_volver,lsigno) )
